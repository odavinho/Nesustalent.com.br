          ...
          {generatedContent && (
            <div className="mt-8 pt-6 border-t space-y-6">
              ...
              <div className="space-y-4">
                <Textarea label="Descrição Geral" defaultValue={generatedContent.description} rows={4} />
                <Textarea label="Responsabilidades (separado por nova linha)" defaultValue={generatedContent.responsibilities.join('\\n')} rows={6} />
                <Textarea label="Requisitos (separado por nova linha)" defaultValue={generatedContent.requirements.join('\\n')} rows={6} />
              </div>
